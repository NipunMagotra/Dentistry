...
This document serves as the absolute source of truth for the Clinic OS platform (v1.5.0). It covers the technology stack, application architecture, routing structure, data persistence models, messaging pipeline, and core asynchronous workflows.
